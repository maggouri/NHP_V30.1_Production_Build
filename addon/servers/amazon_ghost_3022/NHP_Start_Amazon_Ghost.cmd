...
title NHP - Start Amazon Ghost (3022)
...
echo Starting Amazon Ghost (3022) ...
powershell -NoProfile -ExecutionPolicy Bypass -File "%NHP_ROOT%\NHP_Start_Ghost_On_Port.ps1" -Port 3022 -MaxWaitSeconds 90
